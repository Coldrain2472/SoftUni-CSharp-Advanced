...
public class StartUp
{
    public static void Main(string[] args)
    {
        ...
        while ((command = Console.ReadLine()) != "Engines done")
        {
            ...
            int engineHorsePower = int.Parse(engineInfo[0]);
            double engineCubicCapacity = double.Parse(engineInfo[1]);

            Engine currentEngine = new Engine(engineHorsePower, engineCubicCapacity);
        ...
        List<Car> filteredCars = carsList.Where(x => x.Year >= 2017)
